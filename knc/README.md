...
You must know the number of classes in your data before using the algorithm.
...
# 5. using the centroids calculate the distance of each data point from the centroids.
...
#       11. calculate the distance of each data point from the centroids, can use Euclidean Distance.
#       12 place each data point into the cluster in which it is closer to the centroid.
#       13. update the global matrix to show which clusters the data points belong currently.
